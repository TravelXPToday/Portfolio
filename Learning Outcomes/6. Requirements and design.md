![Design](./../Images/Requirements-Design/DesignStartImage.png)
...
### User testing
#### Acceptance tests
We did acceptance tests to each other. When one of us made something, the other person tests it without the knowledge. With this way of working we make sure that there are no mistakes in the new futures. For the rest of example acceptance tests see the group portfolio.
